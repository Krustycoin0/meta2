...
const ExploreCard = ({ id, index, active, handleClick, imgUrl, title }) => (
    //  Since we are going to animate explore card one by one, we need to multiply each item index by duration
    // in our case index * 0.5
  <motion.div
      ...
      active !== id ? (
        ...
        : (
            <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-[24px]">
              ...
              <p className="font-normal text-[16px] leading-[20px] text-white uppercase">Enter the lisprocoin Metaverse</p>
